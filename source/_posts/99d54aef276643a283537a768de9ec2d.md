---
layout: post
title: 19-04-2022 1 task per process and lock on files
abbrlink: 99d54aef276643a283537a768de9ec2d
tags: []
categories:
  - Tu vuo far el phdino
date: 1742938065447
updated: 1742938065447
---
...
- Novità relative a Meta:
  ...
  - Ho individuato il principale **collo di bottiglia**: è lo **Storer**, che costretto a operare in maniera sequenziale blocca tutti gli altri processi.
    ...
    - Ho modificato sia il Reader che lo Storer di oc\_ocdm in locale, utilizzando la libreria <https://github.com/tox-dev/py-filelock> menzionata da Simone.
