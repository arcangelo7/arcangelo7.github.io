...
- User testing. Obiezioni Silvio
  - Creare un'immagine Docker che ciascuno può lanciarsi in locale
  - Mettiamo un subset di Meta
  - Fai fare scritto la grounded analysis
  - Il SUS prima della grounded analysis
